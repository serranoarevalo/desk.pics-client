    ...
    <Container>
      <>
        ...
        <Row>
          ...
          한번 모아보면 좋겠다는 생각이 들었어요! 어때요? 동기부여가 되지않나요?
          😉
        </Row>
        <Row>
      ...
      <>
        <Row>Hello</Row>
        <Row>
          We are nomad coders! This is our side project where people can put the
          photo of their desk! so that we can have photos of desks from all
          around the world!
        </Row>
        It would be nice way to inspire each other! So go ahead upload the photo
        of your desk now! Cheers!
      </>
    </Container>
  </Page>
);
